...
namespace MergePDF.View
{
    ...
    public partial class MainWindow : WindowBase
    {
        ...
        private async void ChangeControl(ChangeViewEventArgs commandParam)
        {
            try
            {
                ...
                if (commandParam != null && commandParam.MenuButton is CommandButtons button)
                {
                    ...
                    else if (button.In(CommandButtons.Home, CommandButtons.GoBack, CommandButtons.PDFMerge, CommandButtons.PDFSplit, CommandButtons.PDFPrint,CommandButtons.PDFScan, CommandButtons.PDFCreate))
                    {
        ...
        private void RegisterFactory()
        {
            ...
            Factory.RegisterTransient<CommandButtons>(CommandButtons.PDFScan, (param) => new PDFScanView((ChangeViewEventArgs)param!));
            Factory.RegisterTransient<CommandButtons>(CommandButtons.PDFCreate, (param) => new PDFCreateView((ChangeViewEventArgs)param!));
        }
    }
}